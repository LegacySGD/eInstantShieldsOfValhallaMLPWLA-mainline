...
public class ShieldsOfValhallaMLPWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ShieldsOfValhallaMLPWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/ShieldsOfValhallaMLPWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ShieldsOfValhallaMLPWLAIW/InitOutcome.xml").getDocumentElement();
